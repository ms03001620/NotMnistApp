...
public class ImageUtils {
  ...
  static {
    try {
      ...
      Log.w("ImageUtils","Native library not found, native RGB -> YUV conversion may be unavailable.");
    }
  }
  ...
  public static void saveBitmap(final Bitmap bitmap, final String filename) {
    ...
    try {
      ...
      Log.i("ImageUtils","Exception!"+e.getMessage());
    }
  }
  ...
  public static void convertYUV420ToARGB8888(
    ...
    if (useNativeConversion) {
      try {
        ...
        Log.w("ImageUtils","Native YUV -> RGB implementation not found, falling back to Java implementation");
